...
#   .\install-non-team.ps1 -Project       # project install -> .\.claude\skills\
#   .\install-non-team.ps1 -Dest <dir>    # custom destination
#
...
Write-Host ''
Write-Host 'Next: in Claude Code, type /gm-agent-01-orchestrator to start a Galaxy Map.'
