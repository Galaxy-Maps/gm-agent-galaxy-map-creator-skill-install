...
#
# Usage:
#   bash install-with-agent-teams.sh                # personal install → ~/.claude/skills/
#   bash install-with-agent-teams.sh --project      # project install → ./.claude/skills/
#   bash install-with-agent-teams.sh --dest <dir>   # custom destination
#
...
echo ""
echo "Next: in Claude Code, type /gm-agent-01a-orchestrator-with-agent-teams to start a Galaxy Map."
